...
def load_filename():
    train_file_names = glob.glob('C:/Users/asemi/Desktop/Data/ACDC/3 class/Training/Images/*.png')
    val_file_names = glob.glob('C:/Users/asemi/Desktop/Data/ACDC/3 class/Testing/Images/*.png')
...
def train_model(model, criterion, optimizer, train_load,val_load,num_classes,num_epochs=200):
    ...
    # Intializinf Lists to store the loss of each epoch and save them 
    loss_list=[]
